...
?>
    ...
    <!-- ============================= Scored Posts Container -->
    <div id="reviews-panel" class="container slide-panel">

        <div class="row">
            <div class="col-md-12">

                <h3 class="pretitle"><span><?php _e('Latest Reviews', 'nadia'); ?></span></h3>
                ...
                <div class="flexslider">
                    ...
                    <?php
                        $args = array(
                            ...
                            'meta_key' => 'meta_dph_review_score',
                            );
